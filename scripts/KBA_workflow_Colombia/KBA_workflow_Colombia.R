...
packagesNeed<- c("magrittr", "terra", "raster", "sf", "pbapply", "this.path", "rjson", "gdalcubes", "rstac", "jsonlite", "gdalUtilities") # Define the list of required packages to run the script

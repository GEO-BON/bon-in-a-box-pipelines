...
```{r}
get_info_collection("https://io.biodiversite-quebec.ca/stac/", collections = c("chelsa-monthly"), bbox = c(-47.02148, -42.53906, -12.98314,  -17.35063), limit = 5000)
```
...
local_velocity <- climate_metrics(cube_current = cube_current,
                                ...
                                # time_span = 59, # you are able to manually set this value
                                  metric = "local"
                               )

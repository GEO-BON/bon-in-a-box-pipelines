...
output<- list( area_stack= dir_area_4326, dir_stack= dir_stack,files_stack=paste0(dir_stack,'/',names(terra_mask_layers), ".tif"), dir_info_layer= dir_info_layer, dir_data_layer=dir_data_layer)

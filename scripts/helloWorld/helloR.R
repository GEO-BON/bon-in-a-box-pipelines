...
biab_outputs("some_picture", example_jpg)
...
biab_outputs("geo_json", example_json)
...
", some_csv_data)
biab_outputs("some_csv_data", some_csv_data)
...
", some_tsv_data)
biab_outputs("some_tsv_data", some_tsv_data)
